                  ...
                  children: [
                    ...
                    Column(
                      ...
                      children: const [
                        ...
                        TextCustom(
                            text:
                                'برای دیدن عکس های آنها این اکانت را دنبال کنید ',
                            color: Colors.grey,
                            fontSize: 16),
                      ],
                    )
            ...
            child: isPendingFollowers == 0
                ? TextButton(
                    style: TextButton.styleFrom(
                        shape: RoundedRectangleBorder(
                            borderRadius: BorderRadius.circular(50.0))),
                    child: TextCustom(
                        text: isFriend == 1 ? 'ذیل' : 'دنبال کردن',
                        fontSize: 20,
                ...
                : TextButton(
                    ...
                    child: const TextCustom(
                        text: 'گوشواره', fontSize: 20, color: Colors.black),
                    onPressed: () {},
                  )),
        Container(
          height: 43,
          ...
          child: TextButton(
            style: TextButton.styleFrom(
                shape: RoundedRectangleBorder(
                    borderRadius: BorderRadius.circular(50.0))),
            child: const TextCustom(text: 'پیام', fontSize: 20),
              ...
              Column(
                children: [
                  TextCustom(
                      ...
                      fontWeight: FontWeight.w500),
                  const TextCustom(
                      text: 'پست', fontSize: 17, color: Colors.grey),
                ],
              ),
              Column(
                children: [
                  TextCustom(
                      ...
                      fontWeight: FontWeight.w500),
                  const TextCustom(
                      text: 'ذیل', fontSize: 17, color: Colors.grey),
                ],
              ),
              Column(
                children: [
                  TextCustom(
                      ...
                      fontWeight: FontWeight.w500),
                  const TextCustom(
                      text: 'پیروان', fontSize: 17, color: Colors.grey),
                ],
              ),
            ],
          ),
