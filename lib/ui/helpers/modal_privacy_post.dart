      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const Center(
                child: TextCustom(
                    text: 'چه کسی می تواند نظر دهد؟',
                    fontWeight: FontWeight.w500)),
            const SizedBox(height: 15.0),
            const TextCustom(
                text:
                    'انتخاب کنید چه کسی می تواند در مورد شما نظر دهد\n.انتشار',
                fontSize: 16,
                color: Colors.grey,
                maxLines: 2),
